...
public class HttpClientService<T> {
    ...
    public T getWeather(String url, Class<T> responseClass) {
        var request = HttpRequest
                ...
                .build();
                //GET oznacza że pobieramy coś z Api ale nie modyfikujemy i nie zmieniamy w stanie serwera
                //POST - oznacza że coś przekazujemy, zawsze trzeba coś dać w nawiasach
                //header = dodatkowe informacje przekazywane poza url, nie zaśmiecają adresy http, ale to takie dodatkowe info
